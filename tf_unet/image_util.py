...
class ImageDataProvider(BaseDataProvider):
    ...
    :param prior_suffix: suffix pattern for gray prior images, if any. Default None
    ...
    def __init__(self, search_path, a_min=None, a_max=None,
                 data_suffix=".tif", mask_suffix='_mask.tif', prior_suffix=None,
    ...
    def _next_data(self):
        ...
        if self.prior_suffix:
            prior_name = image_name.replace(self.data_suffix, self.prior_suffix)
            prior = self._load_file(prior_name, np.float32)
            img = np.dstack((img, prior)) # Add prior as another channel
